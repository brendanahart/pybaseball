...
def pitching_stats(start_season, end_season=None, league='all', qual=1, ind=1, pit='sta'):
    """
    ...
    soup = get_soup(start_season=start_season, end_season=end_season, league=league, qual=qual, ind=ind, pit=pit)
